...
class ProcessWorker(QObject):
    ...
    def run(self):
        ...
        try:
            ...
            result = red_pdf.main(
                self.folder_path, progress_callback=self.progress_callback
            )
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent: QWidget | None = None):
        ...
        self._window_settings = QSettings(
            QSettings.Format.IniFormat, QSettings.Scope.UserScope, "red", "red_pdf"
        )
    ...
    def pick_folder(self):
        ...
        folder = QFileDialog.getExistingDirectory(
            self, "Select Folder with PDFs", "", QFileDialog.ShowDirsOnly
        )
        if folder:
